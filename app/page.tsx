...
export default function Home() {
  ...
  return (
    <AppContext.Consumer>
      {({ handleFocus, isFocused, editorRef, embedModal, handleImageUpload, imageString, layoutRef, handleEmbedModal, embedButtonRef, embedTabList}) => {
        return (
          <div className="flex items-center h-full justify-center relative">
            <div className={`border border-[#E7F1E9] bg-[#FAFAFA] mt-[100px] w-[90%] md:w-[662px] md:h-[813px] flex-col flex h-[500px] ${embedModal.isOpen ? "hidden":""}`}>
              ...
              <div ref={editorRef} className="grow borde relative">
                <TextEditor embedModal={embedModal} imageString={imageString} handleImageUpload={handleImageUpload} layoutRef={layoutRef} handleFocus={handleFocus} isFocused={isFocused} isOpen={embedModal.isOpen}/>
              </div>
